...
scoreboard objectives add mine_crimson_nylium minecraft.mined:crimson_nylium
scoreboard objectives add mine_warped_nylium minecraft.mined:warped_nylium
...
scoreboard objectives add mine_s_basalt minecraft.mined:smooth_basalt
...
scoreboard objectives add mine_glowstone minecraft.mined:glowstone
...
scoreboard objectives add mine_tube_coral_block minecraft.mined:tube_coral_block
scoreboard objectives add mine_brain_coral_block minecraft.mined:brain_coral_block
scoreboard objectives add mine_bubble_coral_block minecraft.mined:bubble_coral_block
scoreboard objectives add mine_fire_coral_block minecraft.mined:fire_coral_block
scoreboard objectives add mine_horn_coral_block minecraft.mined:horn_coral_block
