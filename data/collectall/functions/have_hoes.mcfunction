...
execute if score @s collect_sculk matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/sculk
execute if score @s collect_oak_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/oak_leaves
execute if score @s collect_birch_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/birch_leaves
execute if score @s collect_acacia_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/acacia_leaves
execute if score @s collect_azalea_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/azalea_leaves
execute if score @s collect_jungle_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/jungle_leaves
execute if score @s collect_dark_oak_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/dark_oak_leaves
execute if score @s collect_spruce_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/spruce_leaves
execute if score @s collect_mangrove_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/mangrove_leaves
execute if score @s collect_f_azalea_leaves matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/f_azalea_leaves
execute if score @s collect_moss_block matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/block/moss_block

#一括破壊
execute if score @s collect_shroomlight matches 1.. at @e[distance=..6,limit=1,predicate=all_common:dropped_item] run function collectall:collected/ikkatsu/shroomlight
